<ul style="background-color: rgb(0, 0, 0)" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
                ...
                <div style="color:white;" class="sidebar-brand-text mx-3">STANNUM NEXUS MINING SARL</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePaiements" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a style="color:black;" class="collapse-item" href="{{ route('payment.create') }}">
                            Effectuer un paiement
                        </a>
                        <a style="color:black;" class="collapse-item" href="{{ route('payment.index') }}">
                            Liste des paiements 
                        </a>
                    </div>
                </div>
            ...
            <li class="nav-item">
                ...
                <div id="collapseAdvance" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a style="color:black;" class="collapse-item" href="{{ route('advance.index') }}">
                            Liste des Avances
                        </a>
                        <a style="color:black;" class="collapse-item" href="{{ route('advance.create')}}">
            ...
            <li class="nav-item">
                ...
                <div id="collapseEmployee" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a style="color:black;" class="collapse-item" href="{{ route('employee.index') }}">
                            Liste des agents 
                        </a>
                        <a style="color:black;" class="collapse-item" href="{{ route('employee.create') }}">
                            Ajouter un agent
                        </a>
                    </div>
                </div>
            ...
            <li class="nav-item">
                ...
                <div id="collapseCategory" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a style="color:black;" class="collapse-item" href="{{ route('category.index') }}">
                            Liste des categories
                        </a>
                        <a style="color:black;" class="collapse-item" href="{{ route('category.create') }}">
            ...
            <li class="nav-item">
                ...
                <div id="collapseDeduction" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a style="color:black;" class="collapse-item" href="{{ route('deduction.index') }}">
                            Retenue sur salaire
                        </a>

                        <a style="color:black;" class="collapse-item" href="{{ route('deduction.create') }}">
